...
{
    public class SerializationWithProxiesTest : AbstractTestFixtureFixture
    {
        [Test]
        ...
        public void Created_proxy_entity_should_be_persistable()
        {
            ...
            using (var transaction = session.BeginTransaction())
            {
                fattura.FatturaPa.FatturaElettronicaHeader.DatiTrasmissione.CodiceDestinatario = "AAAA2";
        ...
        public void Created_proxy_entity_should_handle_PropertyChanged()
        {
            ...
            Check_entity_handles_PropertyChanged(fattura);
        }
