	...
	public partial class SmartLoginOverlay
	{
		...
		public static readonly DependencyProperty WatermarkProperty =
						DependencyProperty.Register( "Watermark", typeof( string ), typeof( SmartLoginOverlay ),
							new PropertyMetadata( "Digita la password",
								(dpo, ea) =>
								{
		...
		/// This is a dependency property. The default value is "Digita le tue credenziali e riprova.".
		/// </summary>
		...
		public static readonly DependencyProperty NoCredentialsInfoProperty =
						DependencyProperty.Register( "NoCredentialsInfo", typeof( string ), typeof( SmartLoginOverlay ),
																new PropertyMetadata( "Credenziali non valide. Digita il nome utente e la parola chiave." ) );
		...
		public static readonly DependencyProperty WrongCredentialsInfoProperty =
									  DependencyProperty.Register( "WrongCredentialsInfo", typeof( string ), typeof( SmartLoginOverlay ),
																			 new PropertyMetadata("Le credenziali di accesso digitate non sono valide. Riprovare oppure contattare l'amministratore di sistema per avere nuove credenziali.") );
		...
		private void btnOK_OnClick(object sender, RoutedEventArgs e)
		{
            ...
            this.btnOKPassword.Visibility = Visibility.Visible;
            this.PasswordBoxControl.Focus();
		}
		...
		public void ShowNoCredentialsMessage()
		{
            ...
            this.btnOKPassword.Visibility = Visibility.Collapsed;
            this.btnOK.Focus();
		}
